  ...
  function arc() {
    ...
    // Or is it a circular or annular sector?
      ...
      // Does the sector’s outer ring have rounded corners?
        ...
        // Otherwise, plot the two corners and the ring.
        else {
...
var symbol = function() {
  ...
  function symbol() {
    var buffer;
    if (!context) context = buffer = path();
    type.apply(this, arguments).plot(context, +size.apply(this, arguments));
    if (buffer) return context = null, buffer + "" || null;
  }
